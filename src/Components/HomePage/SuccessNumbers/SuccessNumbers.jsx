...
const SuccessNumbers = () => {
  ...
  return (
    ...
    >
      ...
      itemscenter justifycenter s_phone:rounded-xl s_phone:py-3 m_phone:px-3  laptop-sm:px-0 laptop:py2   laptop-lg:w-full  "
      >
        ...
        <div
         ...
         tablet:flex-wrap  tablet:justify-center laptop-sm:flex-nowrap laptop-sm:gap-1   laptop:gap-8  laptop:px-10   "
        >
          {SuccessRate.map((success, index) => (
            <div
              key={index}
              className=" flex flex-col items-center   laptop:gap-2 tablet:w-50    laptop-sm:mt-2 laptop-sm:w-47  laptop:p-1   "
            >
              <img
