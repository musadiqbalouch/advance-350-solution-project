...
const SuccessNumbers = () => {
  ...
  return (
    <div
      className="w-full   flex  items-center justify-center text-[#FFFFFF] container m-auto p-10  laptop-lg:p-0 laptop-lg:m-5 desktop:m-auto 
    desktop:mt-10  "
    >
      <div
        className="h65  laptop-lg:w-[89%]  tablet:rounded-4xl bg-linear-[360deg] from-[#1B1C67]  to-[#0096E8] to-[188.17%] flex  flex-col 
      items-center justify-center s_phone:rounded-xl s_phone:py-3 m_phone:px-3  laptop-sm:px-0 laptop:py2  laptop-lg:px-10  "
      >
        ...
        <div
         ...
         tablet:flex-wrap  tablet:justify-around laptop-sm:flex-nowrap laptop-sm:gap-2   laptop:gap-8  laptop:px-10   "
        >
...
export default SuccessNumbers;
{
  ...
  <h3 className="text-3xl  font-bold">$1000,000,000</h3>
  <p className="w-50 text-center">5 Year Financial Budget Models Developed</p>
</div>; */
}
